...
## 蓝奏云下载地址
```
https://wwauw.lanzouu.com/iGCTO3ie7huf
```
## 项目交流群
QQ群
```
...
该模块可以让bot有比较优秀的长期记忆以及记忆管理能力
* 好感度模式(可选)
  
勾选此选项后，在每次对话后会显示助理对你的好感度，好感度的初始值为50，数值范围为[0, 100]
* 显示对话时间(可选)
  
勾选此选项后，会显示助理给你答复的具体时间
...
2.优化了bot的记忆管理能力，现在bot会对一些记忆进行整理(删除一些与最新记忆矛盾的旧记忆，合并相关性高的两段记忆)
